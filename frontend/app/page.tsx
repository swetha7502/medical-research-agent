  ...
  async function submit(q?: string) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (res.status === 429) {
          throw new Error("Daily demo limit reached (50 queries/day). Please check back tomorrow.");
        }
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", background: "var(--bg)" }}>
            ...
            <div className="msg-in" style={{ maxWidth: 640, margin: "20px auto 0" }}>
              <div style={{ display: "flex", gap: 12, alignItems: "flex-start", marginBottom: 28 }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: "0.62rem", color: "var(--teal)", marginBottom: 10, letterSpacing: "0.06em" }}>
                    MedResearch AI · Medi
                  </div>
                  ...
                  <p style={{ fontSize: "0.88rem", color: "var(--text-dim)", lineHeight: 1.7, marginBottom: 16 }}>
                    Ask me any clinical question. I will search PubMed and arXiv using three specialized agents — a Retriever, a Fact-Checker, and a Synthesizer — and return a cited, evidence-graded answer.
                  </p>
                  <p style={{ fontSize: "0.84rem", color: "var(--text-dim)", marginBottom: 12 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                    {SUGGESTED.map(s => (
                      ...
                      >
                        <span style={{ fontSize: "0.6rem", color: "var(--teal)", minWidth: 64, letterSpacing: "0.06em", textTransform: "uppercase" }}>
                          {s.label}
                        </span>
              ...
              <div key={i}>
                ...
                <div className="msg-in" style={{ display: "flex", justifyContent: "flex-end", marginBottom: 16 }}>
                  <div style={{
                    ...
                    <div style={{ fontSize: "0.6rem", color: "var(--blue)", marginBottom: 5, letterSpacing: "0.06em" }}>
                      You
                    </div>
            ...
            {error && (
              <div className="msg-in" style={{ display: "flex", gap: 12, marginBottom: 24 }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: "0.62rem", color: "var(--red)", marginBottom: 5 }}>
                    Notice
                  </div>
        ...
        <div style={{
          ...
          <div style={{ maxWidth: 760, margin: "0 auto" }}>
            ...
            <div style={{ fontSize: "0.6rem", color: "var(--text-muted)", marginTop: 7, textAlign: "center" }}>
